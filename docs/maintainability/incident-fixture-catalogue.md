...
| ZEROHERO Force Discharge recovery after restart | export-session persistence/controller tests; `test_active_export_is_reasserted_then_adopted_after_reload`; `test_export_exact_end_restores_self_use_and_clears_on_reload` | System | Extend the system replay to unavailable feedback and retry exhaustion |
