...
Version 0.2.23 is intentionally limited to local observation and planning terms. It never controls hardware. The repository does not claim hardware compatibility merely because a sensor can be selected in the setup form.
