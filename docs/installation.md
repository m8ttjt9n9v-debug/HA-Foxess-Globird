...
discharge preview independently applies the configured standard feed-in and
ZEROHERO boost windows, and updates with the current time. Rehearsal mode must
be disabled and all
